...
if(indic.make.implied.distri=="TRUE"){
  ...
  # saveRDS(implied.distribution.data, file="./results/EA/EA.Model.Implied.Distribution.RData")
  # ?saveRDS
  
} else{
  implied.distribution.data <- readRDS(file="results/EA/EA.Model.Implied.Distribution.RData", refhook = NULL)
